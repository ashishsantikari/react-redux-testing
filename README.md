...
2. **Clone this repository.** - `git clone https://github.com/ashishsantikari/react-redux-testing` or [download the zip](https://github.com/ashishsantikari/react-redux-testing/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd react-redux-testing`
